...
class LogSearchTab extends React.Component {
    constructor(props) { super(props); this.state = { searchText: "", hours: props.defaultHours || 72, level: "all", maxRows: props.defaultMaxRows || 500, loading: false, error: "", rows: [], truncated: false, hasSearched: false }; }
